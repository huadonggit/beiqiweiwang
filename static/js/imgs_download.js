...
ZoomPic.prototype =
{
    initialize : function (id)
    {
        ...
        this.prev = document.getElementById("prev");//this.wrap.getElementsByTagName("pre")[0];
        this.next = document.getElementById("next");//this.wrap.getElementsByTagName("next")[0];
        this.timer = null;
        this.aSort = [];
        this.iCenter = 3;
        ...
        this.setUp();
       // this.prev.onclick = this._doPrev();
       // this.next.onclick = this._doNext();
