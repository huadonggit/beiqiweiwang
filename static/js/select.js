...
(function($){
    ...
    $.fn.selectCss=function(_speed){
        $(".select-repair-serise").each(function(){
        ...
        $(".select-repair-model").each(function(){
            var speed=_speed||"fast";
            if($(this).data("cssobj")){
                $($(this).data("cssobj")).remove();
            }
        ...
        $(".select-repair-city").each(function(){
            var speed=_speed||"fast";
            if($(this).data("cssobj")){
                $($(this).data("cssobj")).remove();
            }
        ...
        $(".select-repair-area").each(function(){
            var speed=_speed||"fast";
            if($(this).data("cssobj")){
                $($(this).data("cssobj")).remove();
            }
        ...
        $(".select-repair-people").each(function(){
            var speed=_speed||"fast";
            if($(this).data("cssobj")){
                $($(this).data("cssobj")).remove();
            }
            $(this).hide();
            /*2-20*/
            var divselect = $("<div placeholder='选择经销商' class='form-repair-people fl' style='width:33.99%;top:0;'></div>").insertAfter(this).addClass("tag_select");
            $(this).data("cssobj",divselect);
            var divoptions = $("<ul style=''></ul>").appendTo(divselect).addClass("tag_options").hide();
            divselect.click(function(e){
                if($($(document).data("nowselectoptions")).get(0) != $(this).find("ul").get(0)){
