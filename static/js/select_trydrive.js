...
(function($){
    ...
    $.fn.selectCssTryDrive=function(_speed){
        $(".select-trydrive-serise").each(function(){
        ...
        $(".select-trydrive-model").each(function(){
            var speed=_speed||"fast";
            if($(this).data("cssobj")){
                $($(this).data("cssobj")).remove();
            }
        ...
        $(".select-trydrive-city").each(function(){
            var speed=_speed||"fast";
            if($(this).data("cssobj")){
                $($(this).data("cssobj")).remove();
            }
        ...
        $(".select-trydrive-area").each(function(){
            var speed=_speed||"fast";
            if($(this).data("cssobj")){
                $($(this).data("cssobj")).remove();
            }
        ...
        $(".select-trydrive-people").each(function(){
            var speed=_speed||"fast";
            if($(this).data("cssobj")){
                $($(this).data("cssobj")).remove();
            }
            $(this).hide();
            /*2-20*/
            var divselect = $("<div placeholder='选择经销商' class='form-repair-people fl' style='width:33.49%;top:0;'></div>").insertAfter(this).addClass("tag_select");
            $(this).data("cssobj",divselect);
            var divoptions = $("<ul style=''></ul>").appendTo(divselect).addClass("tag_options").hide();
            divselect.click(function(e){
                if($($(document).data("nowselectoptions")).get(0) != $(this).find("ul").get(0)){
